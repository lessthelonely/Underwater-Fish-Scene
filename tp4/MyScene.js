...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cube= new MyUnitCubeQuad(this,this.texture7,this.texture6,this.texture5);
        ...
        this.textures = [this.texture1, this.texture2, this.texture3,this.texture4,this.bottom];
